...
export default {
  ...
  mounted() {
    ...
    this.$refs.veditor.styleObject.width = 'auto';
    this.$refs.veditor.styleObject.height = '640px';
  ...
  methods: {
    ...
    // 获取模块名
    getfunctionMoudal() {
      getfunctionMoudalList(this.params.business_name).then((response) => {
        this.params.module_name = "";
    ...
    getUsername() {
      getInfo().then((response) => {
        console.log("接口返回：" + response.data.name);
